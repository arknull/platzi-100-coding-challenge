...
const Reto5 = () => {
  return (
    <Fragment>
      <h1 className="content__title">Reto Día 5 | Necesitamos vocales</h1>
      <p className="content__description">
        ¿Sin <strong>vocales</strong> podemos entender?
      </p>
      <button className="button">Sin vocales</button>
      <p className="content__paragraph">
        ...
        verisímiles se deja entender que se llamaba «Quijana». Pero esto importa
        poco a nuestro cuento: basta que en la narración dél no se salga un
        punto de la verdad.
      </p>
      <a className="next" href="./6-calculadora.html">
        >
      </a>
    </Fragment>
  );
